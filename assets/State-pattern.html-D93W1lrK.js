import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as e,o as i}from"./app-CdpyF-8S.js";const l={};function p(c,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="以敌人ai逻辑为例学习状态模式" tabindex="-1"><a class="header-anchor" href="#以敌人ai逻辑为例学习状态模式"><span>以敌人AI逻辑为例学习状态模式</span></a></h2><p>一个游戏内存在多种不同类型的敌人，如果不断 if-else ，不仅麻烦，还容易产生错误，这个时候状态模式就显得尤为重要</p><h3 id="有限状态机" tabindex="-1"><a class="header-anchor" href="#有限状态机"><span>有限状态机</span></a></h3><ul><li>你拥有状态机所有可能状态的集合</li><li>状态机同时只能在一个状态</li><li>一连串的输入和事件被发送给状态机</li><li>每个状态都有一系列的转移，每个转移和输入与另一状态相关</li></ul><p>例如：当角色在站立状态时，按下下方向键切换为俯卧状态，跳跃时按下下方向键切换为速降状态。如果输入在当前状态没有被定义转移，输入就被忽略。（同时每个状态有其各自的逻辑）</p><h3 id="状态模式" tabindex="-1"><a class="header-anchor" href="#状态模式"><span>状态模式</span></a></h3><ol><li>写出抽象基类 BaseState</li></ol><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>public abstract class BaseState</span></span>
